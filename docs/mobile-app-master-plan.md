...
| Exact next task | **Review APP-041F4a** (pre-activation initiation hardening). Then commit/deploy hidden → repeat hidden production smoke → design designated test-account allowlist and controlled F4b test window → no public activation yet. Do **not** claim deletion is live. Do **not** enable flags. Parallel: **APP-065**, **APP-015**, **APP-066**, **APP-021**. |
...
- **APP-041F4a:** **IMPLEMENTED — HIDDEN — PENDING REVIEW** — initiation hardening (strict row coherence, race/UI/reverification tests, focus, `/user` force-dynamic); both flags off; no real deletion request.
...
| APP-041F4a | Pre-activation initiation hardening | **IMPLEMENTED — HIDDEN — PENDING REVIEW** | ~2–3 |
...
### Exact next action
**Review APP-041F4a** (pre-activation initiation hardening). Then commit/deploy hidden → repeat hidden production smoke → design designated test-account allowlist and controlled F4b test window → no public activation yet. **Do not** enable flags. **Do not** claim deletion is live. **Do not** claim store compliance until end-to-end deletion is proven.
---
...
| APP-041F4a | 10 | WEBSITE | Pre-activation initiation hardening | IMPLEMENTED — HIDDEN — PENDING REVIEW | ~2–3 | | APP-041F3 | Coherence; races; runtime UI/reauth; force-dynamic | Flags off |
...
**APP-041B1**, **APP-041B2a**, **APP-041B2b**, **APP-041B3a**, **APP-041B3b**, **APP-041C1**, **APP-041C2**, **APP-041C3**, **APP-041D0**, **APP-041D1**, **APP-041E1**, **APP-041E2**, **APP-041E3a**, **APP-041E3b**, **APP-041E4a**, **APP-041E4b**, **APP-041E4c**, **APP-041E4d**, **APP-041F2**, and **APP-041F3** are **COMPLETE**. **APP-041F1** is **APPROVED**. **APP-041F4a** is **IMPLEMENTED — HIDDEN — PENDING REVIEW** (initiation hardening; both flags off). APP-041 / APP-041B remain **IN PROGRESS**. Exact next: **review F4a → commit/deploy hidden → repeat hidden smoke → designated test-account F4b design → no public activation**. Parallel: APP-065, APP-015, APP-066, APP-021 planning. Do **not** mark APP-041 COMPLETE. Do **not** claim end-to-end deletion works.
