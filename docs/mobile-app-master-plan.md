...
| Exact next task | **Review APP-041F3** (hidden `/user` Danger Zone). Then commit/deploy hidden → production proof Danger Zone absent while initiation flag off → controlled F4 designated test-account plan → no public activation yet. Do **not** claim deletion is live. Do **not** enable flags. Parallel: **APP-065**, **APP-015**, **APP-066**, **APP-021**. |
...
- **APP-041F3:** **IMPLEMENTED — HIDDEN — PENDING REVIEW** — `/user` Danger Zone behind exact initiation flag; Clerk `useReverification`; backend still dual-gated; no public visibility while flag off; no real deletion request created.
...
| APP-041F3 | Account Danger Zone UI (flag-hidden) | **IMPLEMENTED — HIDDEN — PENDING REVIEW** | ~2–3 |
...
### Exact next action
**Review APP-041F3** (hidden `/user` Danger Zone). Then commit/deploy hidden → production proof Danger Zone absent while initiation flag off → controlled F4 designated test-account plan → no public activation yet. **Do not** enable flags. **Do not** claim deletion is live. **Do not** claim store compliance until end-to-end deletion is proven.
---
...
| APP-041F3 | 10 | WEBSITE | Account Danger Zone UI (flag-hidden) | IMPLEMENTED — HIDDEN — PENDING REVIEW | ~2–3 | | APP-041F2 | `/user` Danger Zone; `useReverification` | Hidden while flag off |
...
**APP-041B1**, **APP-041B2a**, **APP-041B2b**, **APP-041B3a**, **APP-041B3b**, **APP-041C1**, **APP-041C2**, **APP-041C3**, **APP-041D0**, **APP-041D1**, **APP-041E1**, **APP-041E2**, **APP-041E3a**, **APP-041E3b**, **APP-041E4a**, **APP-041E4b**, **APP-041E4c**, **APP-041E4d**, and **APP-041F2** are **COMPLETE**. **APP-041F1** is **APPROVED**. **APP-041F3** is **IMPLEMENTED — HIDDEN — PENDING REVIEW** (`/user` Danger Zone behind initiation flag; backend dual-gated; both flags off). APP-041 / APP-041B remain **IN PROGRESS**. Exact next: **review F3 → commit/deploy hidden → production proof absent while flag off → controlled F4 before public activation**. Parallel: APP-065, APP-015, APP-066, APP-021 planning. Do **not** mark APP-041 COMPLETE. Do **not** claim end-to-end deletion works.
