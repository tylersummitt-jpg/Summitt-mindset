...
*Project-control document. Version 1.5.22. Created 2026-07-17. Read-only-audit basis. v1.1–v1.5.21 history retained in prior revisions. **v1.5.22 (2026-07-21) — physical Vimeo `dnt=1` playback PASS:** Safari Web Inspector on physical iPhone confirmed Film Room list thumbnails-only; detail player `https://player.vimeo.com/video/1151027178?dnt=1` HTTP 200; Vimeo config `dnt = 1`; playback functional in WKWebView; no blank/Safari trap; Vimeo still processes necessary technical/playback data. **v1.5.21:** Vimeo embed privacy posture (`dnt=1` + `/privacy` §6). **v1.5.20:** public Privacy Policy Meta disclosure. **v1.5.19:** native Meta Pixel physical PASS. **v1.5.18:** code-side native Pixel suppression. **v1.5.17:** store-submission package. **v1.5.16:** APP-015 physical PASS.*
...
| Current phase | **Store / portal path** — auth, membership gate, deletion, APP-015 PASS; native Meta Pixel physical PASS; **public Privacy Policy Meta + Vimeo disclosures COMPLETE**; **Vimeo embed `dnt=1` COMPLETE / physical iPhone playback PASS**; store drafts READY. Apple enrollment waiting on **D-U-N-S**. Icon/splash open (Brooke). TestFlight open. Android deferred. |
...
| Last completed task IDs | **Physical Vimeo `dnt=1` playback PASS (2026-07-21)**; **Vimeo embed hardening + Privacy Policy Vimeo disclosure**; **Public Privacy Policy Meta disclosure**; **Native Meta Pixel suppression COMPLETE / physical PASS**; **APP-042 store-submission drafts**; **APP-015 physical PASS**; public in-app deletion E2E PASS; Create account + membership-gate PASS; APP-041; APP-022; APP-021 |
| Current blocker | **Apple Developer organization enrollment waiting on D-U-N-S.** Also open: Brooke icon/splash; Tyler store listing copy; PrivacyInfo review; TestFlight; Google Play org enrollment; Android. Website Meta/Vimeo policy, native Pixel, and Vimeo `dnt=1` playback no longer blockers. APP-065 parallel. |
...
*End of master plan v1.5.22. Maintained per §14. Do not let it become aspirational fiction — update statuses and evidence every session.*
