...
const REPAIRABLE_FINAL_VOICE_BLOCK_REASONS = new Set<string>([
  ...
  "unearned_made_it_happen",
  "unearned_nice_work",
  "presumed_recurring_anchor_schedule",
  "assume_usual_window",
  "anchor_today_without_confirm",
  "unearned_completion_or_focus_praise",
  "timing_anchor_forever_schedule_claim",
  "journey",
  "powerful",
  "great_step_forward",
