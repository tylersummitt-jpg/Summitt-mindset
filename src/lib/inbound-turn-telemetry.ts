...
export const INBOUND_TURN_TELEMETRY_COMPACT_KEYS = [
  ...
  "inbound_sol_pat_retrieval_attempted",
  "inbound_sol_pat_evidence_present",
  "inbound_sol_pat_source_count",
  "inbound_sol_pat_retrieval_error",
  ...
  // V1 invariant 0: model cannot UPDATE; live RPC field retained.
  ...
  "inbound_sol_coach_relationship_memory_old_total_chars",
  "inbound_sol_coach_relationship_memory_new_total_chars",
