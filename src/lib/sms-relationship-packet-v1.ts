...
export const DAILY_WRITING_BRIEF_OBSERVABILITY_KEYS = [
  ...
  "slot_coaching_context_role",
  "slot_coaching_context_send_rec",
  "writer_system_chars",
  ...
  "daily_brief_thread_visible_send_candidate_count",
  "daily_brief_thread_user_inbound_candidate_count",
  "daily_brief_thread_weekly_candidate_count",
  "daily_brief_thread_filtered_out_count",
  "daily_brief_thread_filtered_out_reason_top",
  "daily_brief_thread_effective_timestamp_rescue_count",
  ...
  "daily_brief_thread_primary_fetch_strategy",
  ...
  "sunday_suppression_after_writer",
  "weekly_writer_invoked",
  ...
  "weekly_thread_message_count",
  "weekly_thread_fallback_used",
  "weekly_thread_recovered_source_rows",
  "weekly_thread_message_source_breakdown",
  "weekly_thread_exact_source_message_count",
  "weekly_thread_legacy_transcript_message_count",
  "weekly_thread_last_outbound_fallback_message_count",
  "weekly_thread_legacy_transcript_fallback_used",
  "weekly_thread_correct_notebook_verified",
  "weekly_thread_notebook_failure_reason",
  "weekly_thread_filtered_out_count",
  "weekly_thread_filtered_out_reason_top",
  "weekly_thread_source_tables_present",
  "weekly_memory_packet_used",
  "weekly_memory_packet_build_failed",
  "weekly_notebook_payload_version",
  "weekly_notebook_verdict",
  "weekly_notebook_verdict_reason",
