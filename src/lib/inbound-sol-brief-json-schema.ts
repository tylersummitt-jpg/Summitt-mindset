...
export function buildInboundSolBriefExactContractPromptAppendix(): string {
  return [
    ...
    "accountability_supporting_quote / life_supporting_quote: exact contiguous substring of latest_inbound_text, or null.",
    ...
    "Return a supporting quote only when those exact member words add meaningful value beyond the matching trophy title: emotion, why it mattered, who was involved, meaningful specificity, reflection, context, or a personal phrase worth remembering. Otherwise null.",
    "Bare confirmations, acknowledgements, logistics, commands, and redundant restatements of the trophy title are usually not worth quoting.",
    ...
    "Example: \"Going to church with Brooke and the kids!\" → life_supporting_quote may be that exact inbound. \"Family vacation\" under title Family Vacation → usually null.",
    "Example: \"Yes — and I pushed through even though I was exhausted.\" → accountability_supporting_quote may be \"I pushed through even though I was exhausted.\" Bare \"yes\" → null.",
