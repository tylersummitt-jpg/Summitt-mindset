...
import { generateEveningTtoDraftBatch } from "@/lib/tyler-text-overview-generate-all";
...
export async function POST(req: Request) {
  try {
    ...
    const result = await generateEveningTtoDraftBatch({ draftForDayKey });
    ...
    console.error("[admin/tyler-text-overview/evening-generate-all] POST failed", err);
