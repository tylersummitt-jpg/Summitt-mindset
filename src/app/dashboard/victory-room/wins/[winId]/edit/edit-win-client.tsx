...
export default function EditWinClient(props: Props) {
  ...
  return (
    <div className={vrSectionCard}>
      ...
      <h1 className={vrSectionTitle}>Edit Victory</h1>

      {props.orphanCommitmentNotice ? (
        <p className={`${vrBodyMuted} mt-4 text-sm`}>
          This Victory’s Season link isn’t on your list. Choosing Not tied to a season will detach it; pick a
          Season to reattach.
        </p>
      ) : null}
          ...
          <div>
            ...
            {confirmingRemove ? (
              <div className="mt-2">
                ...
                <p className={`${vrBodyMuted} mt-2 text-sm`}>
                  This permanently removes the photo. Your Victory stays in Victory Room. This
                  can’t be undone.
                </p>
                {mediaError ? (
