...
export function VictoryCornerstoneSection({ moments, timeZone }: VictoryCornerstoneSectionProps) {
  ...
  return (
    <section className="mb-10" aria-label="Cornerstone moments">
      ...
      <ul className="mt-5 space-y-3">
        {moments.map((m) => (
          <li key={m.id}>
            <article className="rounded-lg border border-stone-200 border-l-4 border-l-stone-500 bg-stone-50/80 px-4 py-3 shadow-sm">
