...
export const vrPageGlow =
  "pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_90%_55%_at_50%_-5%,rgba(249,115,22,0.28),transparent_58%),radial-gradient(ellipse_70%_45%_at_100%_0%,rgba(249,115,22,0.08),transparent_52%),radial-gradient(ellipse_55%_35%_at_0%_100%,rgba(30,58,95,0.35),transparent_48%)]";
